...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # ---- Splitter: Left = Core list, Right = Offset controls ----
        splitter = QSplitter(Qt.Orientation.Horizontal)
        main_layout.addWidget(splitter, 1)

        # Left widget: Core selection list
        left_widget = QWidget()
        ...
        # Right widget: Offset controls and quick actions
        ...
        # Prevent either side from being hidden entirely
        ...
        # ---- Bottom section: Profile and boot management ----
